...
for SCENE in "${SCENE_LIST[@]}"; do
    ...
    # CUDA_VISIBLE_DEVICES=$GPU python metrics.py --model_path $SAVE_PATH/$DATASET/"$SCENE"_rgb_down2x --batch_size 16 --rgb
    ...
    # CUDA_VISIBLE_DEVICES=$GPU python metrics.py --model_path $SAVE_PATH/$DATASET/"$SCENE"_thermal_down2x --batch_size 16 --thermal
done
