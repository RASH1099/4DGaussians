...
SCRIPTS=(
  "MeetingRoom_Bacon.sh"
  "MeetingRoom_DeliverIcePacks.sh"
  "MeetingRoom_EatIceCream.sh"
  "MeetingRoom_flare.sh"
  ...
  "MeetingRoom_PourHotWater.sh"
  "MeetingRoom_WhiteFoamCovers.sh"
)

stamp="$(date '+%Y%m%d_%H%M%S')"
SUMMARY_CSV="${LOG_DIR}/summary_meetingroom_${stamp}.csv"
MASTER_LOG="${LOG_DIR}/all_meetingroom_${stamp}.log"
